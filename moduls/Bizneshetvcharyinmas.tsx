...
import Biznessakagin from "./Biznessakagin";

export default function Bizneshetvcharyinmas() {
  ...
  const packages = [
    {
      ...
      name: "PRO",
      details: [
        { id: 1, gb: "https://www.telecomarmenia.am/images/product_apps/1/1616485758842.png", gbText: "40 ԳԲ", minutes: "1500 րոպե", channels: "60 ալիք", price: "3,700 դր. / ամիս." },
        { id: 2, gb: "https://www.telecomarmenia.am/img/tariff-modal/icon.svg", gbText: "ԳԲ", minutes: "3,500 րոպե", channels: "110 ալիք", price: "5,200 դր. / ամիս." },
        { id: 3, gb: "https://www.telecomarmenia.am/img/tariff-modal/icon.svg", gbText: "ԳԲ", minutes: "6,000 րոպե", channels: "110 ալիք", price: "5,200 դր. / ամիս." },
      ],
    },
    {
      id: 2,
      name: "Բիզնես",
      details: [
        { id: 1, gb: "https://www.telecomarmenia.am/images/product_apps/1/16164855270624.png", gbText: "6 ԳԲ", minutes: "250 րոպե", channels: "60 ալիք", price: "3,000 դր. / ամիս." },
        { id: 2, gb: "https://www.telecomarmenia.am/images/product_apps/1/16164855270624.png", gbText: "10 ԳԲ", minutes: "350 րոպե", channels: "110 ալիք", price: "5,000 դր. / ամիս." },
      ],
    },
    {
      id: 3,
      name: "Սմարթ",
      details: [
        { id: 1, gb: "https://www.telecomarmenia.am/img/tariff-modal/icon.svg", gbText: "ԳԲ", minutes: "500 րոպե", channels: "110 ալիք", price: "9,500 դր. / ամիս." },
      ],
    },
    {
      id: 4,
      name: "Be Free",
      details: [
        { id: 1, gb: "https://www.telecomarmenia.am/images/product_apps/1/16164856193267.png", gbText: "20 ԳԲ", minutes: "3000 րոպե", channels: "30 ալիք", price: "3,000 դր. / ամիս." },
      ],
    },
  ];
