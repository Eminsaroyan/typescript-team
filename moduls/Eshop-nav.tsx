        ...
        <nav className="h-[60px] ml-[30px]">
          <ul className="list-none flex ml-[30px] h-[60px]  items-center">
            <li>
              <Link
                to="/smartphones"
                className="cursor-pointer px-[32px] py-0 no-underline text-[#000000]"
              >
                Սմարթֆոններ
              </Link>
            </li>
            <li>
              <Link
                to="/numbers"
                className="cursor-pointer px-[30px] py-0 no-underline text-[#000000]"
              >
                Համարներ
              </Link>
            </li>
            <li>
              <div className="relative group">
                <Link
                  to="/equipment"
                  className="text-[#2c3843] px-[30px] py-0 font-medium text-[16px] cursor-pointer no-underline block py-2 px-4 transition-colors duration-200"
                >
                  Սարքավորումներ
                </Link>

                <ul className="absolute top-full text-start left-0 w-[200px] list-none leading-[3] bg-[#f8f9f9] rounded-b-[12px] shadow-xl z-50 hidden group-hover:block transition-all duration-300">
                  {[
            ...
            <li>
              <div className="relative group">
                <Link
                  to="/accessories"
                  className="cursor-pointer px-[30px] py-0 no-underline text-[#2c3843] font-medium text-[16px] block py-2 px-4 transition-colors duration-200"
                >
                  Աքսեսուարներ
                </Link>
