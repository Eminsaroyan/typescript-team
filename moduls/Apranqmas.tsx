...
export default function Apranqmas({ id, image, name, gin, aparic }) {
    ...
    return (
        <div className="h-[500px] pt-[26px] pr-[20px] pb-[20px] pl-[20px] relative flex flex-col items-center border border-[#9E9E9E]  h-[600px] rounded-[12px] p-[10px] hover:shadow-[0_4px_25px_rgba(0,0,0,0.2)] hover:scale-[1] transition-all duration-300">
